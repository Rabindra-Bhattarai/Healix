...
const NAV_ITEMS = [
  ...
  { href: "/doctor/messages", label: "Messages", icon: "chat" },
  { href: "/doctor/profile", label: "Profile", icon: "account_circle" },
];
      ...
      >
        <div className="px-6 pb-10 flex items-start justify-between">
          <div>
            ...
            <p className="font-body-md text-body-md text-on-surface-variant/70">Doctor Portal</p>
          </div>
          <button
            onClick={() => setOpen(false)}
