...
const NAV_ITEMS = [
  ...
  { href: "/patient/appointments", label: "Book", icon: "calendar_add_on" },
  { href: "/patient/queue", label: "Queue", icon: "reorder" },
  { href: "/patient/vault", label: "Vault", icon: "lock" },
  { href: "/patient/messages", label: "Messages", icon: "chat" },
      ...
      >
        <div className="px-6 pb-10 flex items-start justify-between">
          <div>
            ...
            <p className="font-body-md text-body-md text-on-surface-variant/70">Healthcare SaaS</p>
          </div>
          <button
            onClick={() => setOpen(false)}
